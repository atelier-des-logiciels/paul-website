  ...
  return (
    <div className="text-center py-32 lg:py-72 w-full">
      ...
      <div className="flex gap-2 justify-center flex-col md:flex-row px-6">
        <a className="border-2 rounded-full p-4 border-primary-600 text-primary-600 hover:bg-primary-600 hover:text-white">mes services</a>
        <a href="#contact" className="p-4 border-primary-600 text-primary-600 hover:underline underline-offset-8">discutons de vos besoins</a>
      </div>
    </div>
  );
}